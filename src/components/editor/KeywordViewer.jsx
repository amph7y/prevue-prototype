...
const KeywordViewer = ({ state, actions }) => {
    ...
    const navButtons = (
        <div className="flex justify-between">
            ...
            <button type="button" onClick={() => setStep(3)} className="inline-flex items-center gap-x-2 rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
                Build Queries
